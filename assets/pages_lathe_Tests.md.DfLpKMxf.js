var R=Object.defineProperty;var T=(o,X,s)=>X in o?R(o,X,{enumerable:!0,configurable:!0,writable:!0,value:s}):o[X]=s;var d=(o,X,s)=>T(o,typeof X!="symbol"?X+"":X,s);import{d as S,p as P,o as l,c as r,j as G,F as m,C as Q,t as u,Y as f,ae as w,_,a as U,G as W}from"./chunks/framework.Cs8hIhTA.js";const g=["id"],h={class:"testCode"},N=["onUpdate:modelValue","onInput"],x=S({__name:"Tests",setup(o){function X(e){return e.replace(/^\s*[\r|\n]/g,"")}function s(e){return e.replace(/[\r|\n]/gm,"")}function F(e){return e.replace(/ /gm,"")}function i(e){return e=X(e),e=F(e),e=C(e),e=e.toUpperCase(),e}function p(e){return e=s(e),e=F(e),e=e.toUpperCase(),e}function C(e){return e.replace(/([a-zA-Z])/gm," $1")}class t{constructor(a){d(this,"name");d(this,"testCode");d(this,"inputCode");const{name:n,testCode:Z}=a;this.name=n,this.testCode=i(Z||""),this.inputCode=""}}const c=P([new t({name:"程序头",testCode:`
刀尖方位号参考图：
